...
　<h2><strong> Life is tough, keep swimming.</strong></h2>
...
　　　　<div class="list-parts"> <div class="text-parts"> <p><strong>宇都宮スイムマスターズ連合について</strong></p>
        ...
        <div class="list-parts">
          ...
          <h4> 
            ...
            <p>スイムイクスピリエンスちゃんの座右の銘は、<strong>「嘘をつかない。人に迷惑をかけない。お友達には思いやりを持って接する」。</strong></p>
          </h4>
          </div>
        </div>
        ...
        <div class="list-parts">
          ...
          <h4>  
            ...
            <p>主に芳賀町で目撃例が多く、子どもとスポーツに真剣に向き合っている人には優しいとの情報もあるが、バタジイへのリスペクトを行わず、逆に攻撃したり、身の程を知らないオトナ相手には、
            バタジイのバタフライアームで、練習しているフリをして、首にラリアート攻撃をしてくるとの噂があるので、遭遇したなら、不用意に近寄らず、水面を荒らさずに後ろ向きの状態でプールやレーンから離れるのが命を守る方法と言われる。</p>
            <p>好きなこと、好きなものは、清らかな心を持つ子どもとの交流と、上三川町のらー麺 藤原家のつけ麺、抹茶スイーツ全般で、プール以外の場でも多数の出没情報がある。
            基本、バタフライを速く泳ぐことに全精力を注いでいる妖怪のため、プール以外で遭遇できるのはレア。またレアなため、遭遇した人間には幸せが訪れるという幸運の妖怪でもある。</p><br>
            <p>バタジイの口グセは、<strong>「練習する以外で上手く速くなる選手いる？いねーよな！」</strong>（以上、民明書房刊より）</p>
